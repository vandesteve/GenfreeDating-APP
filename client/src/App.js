...
// 👇 1. Define the socket server URL using an environment variable
// It falls back to http://localhost:3001 if the variable isn't set.
...
const App = () => {
    ...
    useEffect(() => {
        ...
        setSocket(socketIO(SOCKET_SERVER_URL))
    }, [])
